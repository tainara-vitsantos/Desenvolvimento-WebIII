...
namespace Academico.Controllers
{
    public class DisciplinasController : Controller
    {
        ...
        public DisciplinasController(AplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var aplicationDbContext = _context.Disciplina.Include(d => d.Curso);
        ...
        public async Task<IActionResult> Create([Bind("DisciplinaId,Nome,Semestre,CursoId")] Disciplina disciplina)
        {
            ...
            ViewData["CursoId"] = new SelectList(_context.Set<Curso>(), "CursoId", "CursoId", disciplina.CursoId);
            return View(disciplina);
        }
